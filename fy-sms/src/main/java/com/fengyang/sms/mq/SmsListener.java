package com.fengyang.sms.mq;

import com.fengyang.common.utils.JsonUtils;
import com.fengyang.sms.config.SmsProperties;
import com.fengyang.sms.utils.SmsUtils;
...
public class SmsListener {
    ...
    @RabbitListener(bindings = @QueueBinding(
            ...
            exchange = @Exchange(name = "fy.sms.exchange", type = ExchangeTypes.TOPIC),
            key = {"sms.verify.code"}
    ))
